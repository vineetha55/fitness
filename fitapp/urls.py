...
urlpatterns=[
    ...
    path('SaveMemberPayment/<id>',views.SaveMemberPayment),
...
#membercart
    ...
    path("MemberMonthlyPayment/",views.MemberMonthlyPayment),
    path("SaveMemberMonthlyPayment/<id>",views.SaveMemberMonthlyPayment),
    #path("ViewMemberMonthlyPayment/<id>",views.ViewMemberMonthlyPayment),
    path("Payment_success_fees/",views.Payment_success_fees),
    path("Payment_success_fees/<payment>",views.Payment_success_fees),

    path('ViewMemberPayment/',views.ViewMemberPayment),

    path("ViewMemberMonthlyPayment/", views.ViewMemberMonthlyPayment),
    path("ViewMemberMonthlyPayment1/<id>",views.ViewMemberMonthlyPayment1),
    path("MemberViewMonthlyPayment/",views.MemberViewMonthlyPayment),


    #filter
    path("filter_by_category/<id>",views.filter_by_category),

    #package
    path("package_check/",views.package_check),
    path("package_not_expired/",views.package_not_expired),
    path("package_booking/",views.package_booking),
    path("get_pack_details/",views.get_pack_details),
    path("save_package_booking/",views.save_package_booking),
    path("pack_payment/<pay>",views.pack_payment,name="pack_payment"),
    path("Payment_success_pack/<pay>",views.Payment_success_pack)
